...
import mollah.yamin.xmail.data.models.EmailAttachment
...
object LocalEmailsDataProvider {
    ...
    private val threads = listOf(
        Email(
            id = 8L,
            sender = LocalUserAccountsDataProvider.getContactAccountByUid(13L),
            recipients = listOf(LocalUserAccountsDataProvider.getDefaultUserAccount()),
        ...
        Email(
            id = 6L,
            sender = LocalUserAccountsDataProvider.getContactAccountByUid(10L),
            recipients = listOf(LocalUserAccountsDataProvider.getDefaultUserAccount()),
        ...
        Email(
            id = 7L,
            sender = LocalUserAccountsDataProvider.getContactAccountByUid(9L),
            recipients = listOf(LocalUserAccountsDataProvider.getDefaultUserAccount()),
            subject = "Delivered",
        ...
        Email(
            id = 1L,
            sender = LocalUserAccountsDataProvider.getContactAccountByUid(6L),
            recipients = listOf(LocalUserAccountsDataProvider.getDefaultUserAccount()),
        ...
        Email(
            id = 2L,
            sender = LocalUserAccountsDataProvider.getContactAccountByUid(5L),
            recipients = listOf(LocalUserAccountsDataProvider.getDefaultUserAccount()),
    ...
    val allEmails = listOf(
        ...
        Email(
            2L,
            LocalUserAccountsDataProvider.getContactAccountByUid(5L),
            listOf(LocalUserAccountsDataProvider.getDefaultUserAccount()),
            "Bonjour from Paris",
        ...
        Email(
            3L,
            LocalUserAccountsDataProvider.getContactAccountByUid(8L),
            listOf(LocalUserAccountsDataProvider.getDefaultUserAccount()),
            "High school reunion?",
            """
                Hi friends,
        ...
        Email(
            id = 4L,
            sender = LocalUserAccountsDataProvider.getContactAccountByUid(11L),
            recipients = listOf(
                LocalUserAccountsDataProvider.getDefaultUserAccount(),
                LocalUserAccountsDataProvider.getContactAccountByUid(8L),
                LocalUserAccountsDataProvider.getContactAccountByUid(5L)
            ),
            subject = "Brazil trip",
